...
ASSUSERNAME = getenv("ASSUSERNAME", "II_FALCON_X_II")
EVALOP = list(map(int, getenv("EVALOP", "7046757969").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1002594372607))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Akhand_aryavart")
