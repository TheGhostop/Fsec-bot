...
async def start(_, msg):
    buttons = [
            ...
            [
             ...
             InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/Akhand_aryavart"),
             ],
     
             [
             InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ", url="https://t.me/Akhand_aryavart"),          
             InlineKeyboardButton("︎ᴍᴜsɪᴄ", url=f"https://github.com/"),
             ],
